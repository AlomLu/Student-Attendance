<?php 
    ...
    if(isset($_POST['selected_month'])){
        ...
        $selected_class_id = isset($_POST['selected_class_id']) ? $_POST['selected_class_id'] : null;
        $selected_subject_id = isset($_POST['selected_subject_id']) ? $_POST['selected_subject_id'] : null;

        echo "$currentMonthYear $selected_class_id $selected_subject_id";
...
<?php
    ...
    if($selected_class_id){
        $attendance_check_query_monthly .= "AND tbl_attendance_record.class_id = '$selected_class_id'";
    }
    if($selected_subject_id){
        $attendance_check_query_monthly .= "AND tbl_attendance_record.subject_id = '$selected_subject_id'";
    }

    $attendance_check_query_monthly .= "GROUP BY 
                                        tbl_attendance_record.teacher_id, 
                                        tbl_attendance_record.class_id, 
                                        tbl_attendance_record.subject_id,
