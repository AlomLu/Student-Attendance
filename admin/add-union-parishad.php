            ...
            <div class="box round first grid">
               ...
               <?php 
                    if($_SERVER['REQUEST_METHOD'] == 'POST'){
                        ...
                        $upazila_id = mysqli_real_escape_string($db->link, $fm->validation($_POST['upazila_id']));
                        
                        $union_name = mysqli_real_escape_string($db->link, $fm->validation($_POST['union_name']));
                        $union_name = strtolower($union_name);

                        if($div_id == '' || $dis_id == '' || $upazila_id == '' || $union_name == ''){
                            echo "<span class='error'>Filed must not be empty</span>";
                        }else{
                            $query = "INSERT INTO tbl_union (div_id, dis_id, upazila_id, union_name) VALUES ('$div_id', '$dis_id', '$upazila_id', '$union_name')";
                ...
                ?>
                 <form action="" method="POST">
                    <table class="form">
                        ...
                        <tr>
                            <td>
                                <select name="upazila_id" id="selected_upazila">
                        ...
                        <tr>
                            <td>
                                <input type="text" name="union_name" placeholder="Enter Union Name..." class="medium" />
                            </td>
                        </tr>
						<tr> 
                            <td>
