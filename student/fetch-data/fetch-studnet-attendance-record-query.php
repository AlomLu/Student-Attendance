<?php 
    ...
    if(isset($_POST['selected_date'])){
        ...
        $student_query = "SELECT * FROM tbl_attendance_record WHERE user_id = '$student_id' AND DATE_FORMAT(created_at, '%M %d %Y') = '$selected_date' ";
  ...
  echo "<tr>
        ...
        <td>".$teacher_name."</td>
        <td>";
                $presentCheck_query = "SELECT * FROM tbl_attendance_record WHERE user_id = '$student_id' AND subject_id = '$subject_id' AND DATE_FORMAT(created_at, '%M %d %Y') = '$selected_date' AND attendance_status ='1' ";
       ...
       echo  "</td>
        <td>";
                $presentCheck_query = "SELECT * FROM tbl_attendance_record WHERE user_id = '$student_id' AND subject_id = '$subject_id' AND DATE_FORMAT(created_at, '%M %d %Y') = '$selected_date' AND attendance_status ='2' ";
                $present_result = $db->select($presentCheck_query);
       ...
       echo  "</td>
        <td>";
                $presentCheck_query = "SELECT * FROM tbl_attendance_record WHERE user_id = '$student_id' AND subject_id = '$subject_id' AND DATE_FORMAT(created_at, '%M %d %Y') = '$selected_date' AND attendance_status ='3' ";
                $present_result = $db->select($presentCheck_query);
       ...
       echo "</td>
        ...
        echo "<p style='margin-top: 10px'>No attendance record available for $selected_date</p>";
